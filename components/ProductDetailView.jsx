      ...
      <div className="w-full lg:w-1/3 flex flex-col">
        <div className="px-6">
          ...
          <div className="mb-6">
            ...
            <div className="text-green-700 text-sm font-semibold mb-2">Base Price: 01 Person</div>
            <table className="w-full border-separate border-spacing-0">
              <thead>
                <tr className="bg-orange-100">
                  ...
                  <th className="text-green-800 text-lg font-semibold px-3 py-2 text-center">In INR</th>
                  <th className="text-green-800 text-lg font-semibold px-3 py-2 text-center rounded-tr-lg">US Dollar</th>
                </tr>
              </thead>
              <tbody>
                {/* Example static rows. Replace with dynamic mapping if you have data */}
                <tr className="bg-blue-200 border-y-2 border-white">
                  <td className="px-3 py-2"></td>
                  <td className="px-3 py-2 border-l-2 border-red-500"></td>
                  <td className="px-3 py-2 border-l-2 border-red-500"></td>
                </tr>
